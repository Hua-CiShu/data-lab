// core.js — DataStore / Modules / loadFile / registerAdapter / Adapters / resetData
...
export const Adapters = {
  ...
  get: (name) => _adapters.get(String(name || '').toLowerCase()),
  has: (name) => _adapters.has(String(name || '').toLowerCase()),
