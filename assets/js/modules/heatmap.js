...
async function ensureChartMatrix(){
  if(!window.Chart){ await import('https://cdn.jsdelivr.net/npm/chart.js@4.4.1/dist/chart.umd.min.js'); }
  if(!(window.Chart.registry && window.Chart.registry.getPlugin('matrix'))){
...
registerModule('analyze/heatmap', async () => {
  ensure(); await ensureChartMatrix();
